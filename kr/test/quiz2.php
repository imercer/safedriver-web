...
<body class="metro">
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">최대 속도는 시속 50km입니다</span>
        </div>
        </div>
        </div>
        </a>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">최소 속도는 시속 50km입니다</span>
        </div>
        </div>
        </div>
        </a>
