...
<body class="metro" style="padding-left: 20px;">
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">속도를 줄이고 안전하게 교차</span>
        </div>
        </div>
        </div>
        </a>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">중지하고 점검에는 기차가 없습니다</span>
        </div>
        </div>
        </div>
        </a>
