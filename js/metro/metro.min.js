...
a,b)},tick:function(){var a=this;this._interval=setInterval(function(){var b,d,c,f;b=Math.floor((a.options.stoptimer-new Date)/1E3);0>b&&(b=0);d=Math.floor(b/2592000);a.updateDuo(0,1,d);b-=2592000*d;c=Math.floor(b/3600);a.updateDuo(2,3,c);b-=3600*c;f=Math.floor(b/60);a.updateDuo(4,5,f);b-=60*f;a.updateDuo(6,7,b);a.options.ontick(d,c,f,b);a.blinkDivider();0===d&&(0===c&&0===f&&0===b)&&(a.options.onstop(),a.stopDigit(),a._trigger("alarm"),clearInterval(a._interval))},1E3)},blinkDivider:function(){this.options.blink&&
