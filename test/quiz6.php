...
<body class="metro" style="padding-left: 20px;">
        ...
        <br>
        <h2>Can The Red Car pass the Green Car in This Scenario?</h2>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">Yes</span>
        </div>
        </div>
        </div>
        </a>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">No</span>
        </div>
        </div>
        </div>
        </a>
