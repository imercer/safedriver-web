...
<body class="metro" style="padding-left: 20px;">
        ...
        <br>
        <h2>There is a large number of cars lined up behind you, what should you do?</h2>
            <br>
            <br>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">Keep as far left as possible to allow vehicles to pass</span>
        </div>
        </div>
        </div>
        </a>
        ...
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">Wait for vehicles to overtake you</span>
        </div>
        </div>
        </div>
        </a>
