...
<head><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
    <link rel="stylesheet" href="/css/metro-bootstrap.css"> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /> <title>SafeDriver - Drive Safe on New Zealand Roads</title>
        <script src="/js/jquery/jquery.min.js"></script><script src="/js/speed.js"></script>
  ...
  <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
        <script>
            localStorage.setItem("lang", "en-legacy");
        </script>
    </head>
<body class="metro">
        <div class="container">
        <nav class="navigation-bar dark">
            ...
            <br>
<center>
    <a href="en-legacy/learn/index.html">
    ...
    <a href="en-legacy/test/index.html">
    ...
    <a href="en-legacy/drive/status.php">
    <div class="tile double bg-lightOlive" style="padding-left: 25px; float: left">
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">Road Status</span>
        </div>
        </div>
        </div>
        </a>
    <a href="en-legacy/settings/index.html">
    <div class="tile double bg-lightGrey" style="padding-left: 25px; float: left">
        <div class="brand bg-black">
            <span class="label fg-white" style="text-align: left">Settings</span>
        </div>
        </div>
        </div>
        </a>
